...
class TestBasicVectorSearch:
    ...
    def test_vector_search_respects_limit(self, retrieval_agent):
        ...
        limit = 3
        results = retrieval_agent.vector_search_tasks("debugging", limit=limit)
...
class TestSemanticMatching:
    ...
    def test_vector_search_semantic_match(self, retrieval_agent):
        ...
        """
        results = retrieval_agent.vector_search_tasks("observability tools")
    ...
    def test_vector_search_synonym(self, retrieval_agent):
        ...
        """
        results = retrieval_agent.vector_search_tasks("documentation")
    ...
    def test_vector_search_different_phrasing(self, retrieval_agent):
        ...
        results1 = retrieval_agent.vector_search_tasks("how to find bugs")
        results2 = retrieval_agent.vector_search_tasks("debugging")
...
class TestEmbeddingGeneration:
    ...
    def test_embed_text_dimensions(self, retrieval_agent):
    ...
    def test_embed_text_consistency(self, retrieval_agent):
        """Same input produces same embedding."""
        text = "consistent test query"
        
        emb1 = retrieval_agent.embed_text(text)
        emb2 = retrieval_agent.embed_text(text)
        
        assert emb1 == emb2, "Same input should produce same embedding"

    def test_embed_text_different_inputs(self, retrieval_agent):
        """Different inputs produce different embeddings."""
        emb1 = retrieval_agent.embed_text("debugging")
        emb2 = retrieval_agent.embed_text("webinar")
...
class TestEdgeCases:
    ...
    def test_empty_query(self, retrieval_agent):
        ...
        try:
            results = retrieval_agent.vector_search_tasks("")
    ...
    def test_very_long_query(self, retrieval_agent):
        ...
        try:
            results = retrieval_agent.vector_search_tasks(long_query)
    ...
    def test_special_characters_in_query(self, retrieval_agent):
        ...
        try:
            results = retrieval_agent.vector_search_tasks(special_query)
